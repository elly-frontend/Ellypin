...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.exportRopstenCsv = function () {
        this.dataService.etherscan('ropsten', 'contractaddress', '0x44128f17132ae9aac62ce8a47c0cf5465e225c97').subscribe(function (res) {
            console.log(res);
            var data = [];
    ...
    AdminComponent.prototype.exportRinkebyCsv = function () {
        this.dataService.etherscan('rinkeby', 'contractaddress', '0xe12fFbfa5FF156A195b9e52B9D39091253f8DecC').subscribe(function (res) {
            console.log(res);
            var data = [];
            if (res.result.length) {
                res.result.forEach(function (element) {
